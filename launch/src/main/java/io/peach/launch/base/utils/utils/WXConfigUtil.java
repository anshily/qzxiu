package io.peach.launch.base.utils.utils;
...
//            vip出行
    public final static String APPID = "wx43cef34b6f5f8a99";//微信公众号id

    public final static String APP_SECRECT = "bb2dcba032500d88dcb4c43a3b1fc848";//服务号的应用密码

    public final static String MCH_ID = "1504510371";//商户号
    public final static String API_KEY = "CyhIOpTV0jeOcV0IWtNxIqlxnG0jirUL";//微信支付商家API密钥

    public final static String BASE_URL = "http://www.51cnews.com/";
//	public final staticByhang String BASE_URL = "http://q.hnqingyun.com/";
    ...
    //    二维码支付 沙箱环境 上线时 请改为 支付环境
//    public final static String QRCODE_PAY_URL = "https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder";
}
