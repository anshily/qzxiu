...
import io.peach.launch.base.utils.utils.WXConfigUtil;
...
public class WeChatSDK {
    ...
    public static String  getJsApiTicket() throws IOException {
        ...
        if (file.exists()) {
            ...
            if (Long.valueOf(jsapi_ticket_data.get("expire_time").toString()) < Long.valueOf(getNowTimestamp())){
                ...
                if (data != null){
                    jsapi_ticket_obj.put("expire_time",Long.valueOf(getNowTimestamp()) + 5000000);
    ...
    public static String  getAccessToken() throws IOException {
        ...
        if (file.exists()) {
            ...
            if (Long.valueOf(access_token_data.get("expire_time").toString()) < Long.valueOf(getNowTimestamp())){
                ...
                if (data != null && data.contains("access_token")){
                    access_token_obj.put("expire_time",Long.valueOf(getNowTimestamp()) + 5000000);
